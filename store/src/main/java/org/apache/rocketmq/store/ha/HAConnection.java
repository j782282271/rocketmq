...
public class HAConnection {
    ...
    //master作为server，准备读取slave发来的offset消息，然后通知write线程，把master大于offset的消息，把msg传输给slave
        ...
        public void run() {
            ...
            while (!this.isStopped()) {
                try {
                    ...
                    //上面面发送数据完毕，读取下次需要传输的commitLog msg，并传输数据
