...
public class AdminBrokerProcessor implements NettyRequestProcessor {
    ...
    private synchronized RemotingCommand updateAndCreateTopic(
    ...
    /**
     * 删除topic配置,对应config/topics.json
     * 删除topic的队列，对应consumequeue/**Topic
     */
    ...
    /**
     * 将TopicConfigManager，所有内容序列化返回给客户端
     */
    ...
    /**
     * 更新broker配置
     * 如果涉及到broker的权限改变，还需要通知nameServ
     */
    ...
    /**
     * 按照timestamp查询某个queue的logic offset
     */
    ...
    /**
     * 按照 queueId查询其最大的logic offset
     */
    private RemotingCommand getMaxOffset(
            ChannelHandlerContext ctx, RemotingCommand request) throws RemotingCommandException {
    ...
    /**
     * 按照 queueId查询其最小的logic offset
     */
    private RemotingCommand getMinOffset(
            ChannelHandlerContext ctx, RemotingCommand request) throws RemotingCommandException {
